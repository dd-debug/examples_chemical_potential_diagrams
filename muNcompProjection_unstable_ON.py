...
def get_ON_entries():#ternary_N_O_without_nitrates
...
getridlist = ["NaNO2", "K3NO3", "K3NO4", "S3(NO7)2", "S2NO9", "PNO", "NOF", "NClO","HNO3","H5NO", "NClO3"]
gaslist = ["N2","O2","N2O","NO2","N2O5","NO","N2O3","NO3","NO4","NO6","N4O9"]
import random
...
for ee in formulas:
    ...
    #         continue
        ...
        fig = plotter.get_ON_ternary_projection_equilLine_plot(projEle, texts, \
            ...
            alpha = 0.2,label_domains = True)
        fn = str(m) + "_" + ee+".png"
        filenames.append(fn)
    except:
        print("hahahahahahah",ee)
# plt.show()
